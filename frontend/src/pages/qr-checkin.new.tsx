            ...
            <Card>
              ...
              <CardContent>
                {!scannerActive ? (
                  <div className="text-center py-12">
                    ...
                    <Button
                      onClick={() => {
                        ...
                        setTimeout(() => handleQRScan("QR001234"), 2000);
                      }}
                  ...
                  <div className="text-center py-12">
                    <div className="mx-auto w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mb-4 animate-pulse">
                      <ScanLine className="h-12 w-12 text-green-600" />
                    </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        {getStatusBadge(scannedGuest.status)}
                      </div>
                      <div className="grid gap-2 text-sm text-gray-600">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span>{scannedGuest.phone}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="font-medium">Ticket:</span>
                          <Badge variant="outline">
                            {scannedGuest.ticketType}
                          </Badge>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="font-medium">Company:</span>
                          <span>{scannedGuest.company}</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <span className="font-medium">QR Code:</span>
                          <span className="font-mono text-xs">
                            {scannedGuest.qr_token}
                          </span>
                        </div>
